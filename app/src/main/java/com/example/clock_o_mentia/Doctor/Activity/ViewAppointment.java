...
import com.example.clock_o_mentia.databinding.ActivityViewAppointmentBinding;
...
public class ViewAppointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.videoCall.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ViewAppointment.this, VideoCallActivity.class);
    ...
    private void setViews() {
        ...
        binding.appointmentName.setText(appointment.getName());
